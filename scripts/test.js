...
assertContains('index.html', ['长远任务监督', 'id="tray-long-tasks"', 'id="lt-page-panel"', 'id="long-task-add-btn"', 'id="long-task-list"', 'id="long-task-status"', 'id="long-task-save-btn"'])
...
assertContains('preload.js', ['notifyConfigChanged', 'onConfigChanged', 'config:changed', 'setPetSize', 'setPetShape', 'startPetDrag', 'movePetDrag', 'endPetDrag', 'openLongTasks', 'open-long-tasks', 'getHermesApiKey', 'setHermesApiKey', 'testHermesAgent', 'chatHermesAgent', 'getLongTaskWebhook', 'setLongTaskWebhook', 'sendLongTaskFeishu'])
assertContains('main.js', ['config:changed', 'workArea', 'const W = workArea.width, H = workArea.height', 'x: workArea.x', 'y: workArea.y', 'screen.getCursorScreenPoint', 'petDragTimer', 'setInterval(movePetWindowToCursor, 16)', 'stopPetDragTimer', 'applyPetWindowShape', 'cursor.x - petDragAnchor.dx', 'cursor.y - petDragAnchor.dy', 'petWindowShape = shape', 'pet:drag-start', 'pet:drag-move', 'pet:drag-end', 'pet:shape:set', 'win.setHasShadow(false)', 'pet:size:set', 'lockWindowSize', 'setMinimumSize', 'setMaximumSize', 'will-resize', 'restoreSize', 'longTasksWin', 'open-long-tasks', "mode: 'long-tasks'", 'HERMES_API_KEY_FILE', 'LONG_TASK_WEBHOOKS_FILE', 'feishu:long-task-webhook:get', 'feishu:long-task-webhook:set', 'feishu:long-task-send', 'sendFeishuWebhookMessage', 'hermes:api-key:get', 'hermes:api-key:set', 'hermes:test', 'hermes:chat'])
